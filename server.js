...
// We use 'path' and 'url' to correctly locate our website files.
...
// Helpers to get the current directory name (required for ES Modules)
...
// This tells the server to make all files in the current directory available (like style.css)
